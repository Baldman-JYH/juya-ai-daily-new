...
REPO_OWNER="${REPO_OWNER:-jujuyaya}"
REPO_NAME="${REPO_NAME:-juya-ai-daily}"
SITE_SUBPATH="${SITE_SUBPATH:-${REPO_NAME}}"
...
LIVE_URL="${LIVE_URL:-https://daily.juya.uk}"
...
Options:
  --owner <owner>       GitHub owner for isite generate (default: jujuyaya)
  --repo <repo>         GitHub repo for isite generate (default: juya-ai-daily)
  --base-url <url>      Zola base URL (default: http://127.0.0.1:4173/<repo>)
  --live-url <url>      Live site URL for snapshot mode (default: https://daily.juya.uk)
